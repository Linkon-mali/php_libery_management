    ...
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                ...
                <li><i aria-hidden="true"></i><a href="javascript: avoid(0)">Return Book List</a></li>
            </ul>
        </div>
    </div>
    <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
                ...
                <div class="panel-content">
                    <div class="table-responsive">
                        <table id="basic-table" class="data-table table table-bordered table-striped nowrap table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $db_info = mysqli_query($conn, "SELECT books.book_name, books.book_image, books.book_author_name, books.book_publication_name, books.book_price, issue_books.date_time, liberyan.name 
                                    FROM books 
                                ...
                                ?> <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-xs btn-warning" disabled>Already Return</button>
                                        </td>
                                    </tr>
                                <?php $id++;
                                }
