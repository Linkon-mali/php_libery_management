                ...
                <div class="panel-content">
                    <div class="table-responsive">
                        <table id="basic-table" class="data-table table table-bordered table-striped nowrap table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $db_info = mysqli_query($conn, "SELECT books.book_name, books.book_image, books.book_author_name, books.book_publication_name, issue_books.date_time, liberyan.name, students.fname, students.lname
                                            FROM books 
                                ...
                                ?> <tr>
                                        <td><?= $id ?></td>
                                        <td><?= $row['book_name'] ?></td>
                                        <td><img style="width: 80px; height: 100px;" src="./book_image/<?= $row['book_image'] ?>" alt="Image"></td>
