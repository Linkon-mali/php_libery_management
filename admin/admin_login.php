    ...
    <div class="wrap">
        ...
        <div class="page-body animated slideInDown">
            ...
            <div style="margin-bottom: 0px;" class="logo">
                <h1 class="text-center">Admin Login From</h1>
            </div>
            <div class="box">
                ...
                <div class="panel mb-none">
                    <div class="panel-content bg-scale-0">
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary btn-block" name="admin_login" value="Admin Login ">
                            </div>
                            <div class="form-group text-center">
                                <span>Don't have an account?</span>
                                <a href="admin_register.php" class="btn btn-block mt-sm">Register</a>
                            </div>
                        </form>
                    </div>
                </div>
